  ...
  return (
        ...
        <div className='entireItem'>
            <div id={id} className="item--container" >
                <div className="image" >
                    <Link to={`/items/${id}`}><img id={id} className='item--image' src={url} alt={name} /></Link>
                </div>
            ...
            <p id={id} className="moreDetails"><Link id={id} className="text--link" to={`/items/${id}`}>More Details</Link></p>
